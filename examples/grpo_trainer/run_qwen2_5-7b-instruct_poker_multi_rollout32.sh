...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/workdir/project-search/rl4search/data/pokerbench-instruct/train.parquet \
    data.val_files=/workdir/project-search/rl4search/data/pokerbench-instruct/test.parquet \
    data.train_batch_size=1024 \
    data.max_prompt_length=2048 \
    data.max_response_length=2048 \
    data.filter_overlong_prompts=True \
    data.truncation='error' \
    actor_rollout_ref.model.path=/workdir/pretrained-models/Qwen-Qwen2.5-7B-Instruct \
