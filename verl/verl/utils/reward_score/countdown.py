...
def compute_accuracy_reward(solution_str, ground_truth, method='strict', format_score=0.1, score=1.):
...
def compute_score(solution_str, ground_truth, method='strict', format_score=0.1, score=1.):
    accuracy_reward = compute_accuracy_reward(solution_str, ground_truth, method, format_score, score)
    format_reward = compute_format_reward(solution_str)
    tag_count_reward = compute_tag_count_reward(solution_str)
